    ...
    <div class="py-4 p-st" :class="{
            ...
            <div class="text-center">
                <form @submit.prevent="sendEmail" method="post">
                    <div class="mb-3" data-aos="fade-up" data-aos-once="true" data-aos-duration="1000">
                        <input type="text" name="name" v-model="name" placeholder="name" class="pinput" :class="{
        pgray: !nightMode,
        ...
        'text-light': nightMode,
                    ...
                    <div class="my-3" data-aos="fade-up" data-aos-once="true" data-aos-duration="1000">
                        <input type="email" name="_replyto" v-model="email" placeholder="email" class="pinput" :class="{
        pgray: !nightMode,
        'pgray-dark': nightMode,
        'text-light': nightMode,
        ...
        'text-light': nightMode,
                    ...
                    <button type="submit" class="mt-1 btn mb-3" data-aos="fade" data-aos-once="true"
...
export default {
    ...
    methods: {
        ...
        async sendEmail() {
            try {
                const response = await fetch("https://formspree.io/f/xoqgypee", {
                    method: "POST",
                    headers: {
